...
export class CreepConfigs {
    ...
    constructor() {
        ...
        this.creepSpawningConfig = {
                ...
                "harvester": new CreepSpawningInfo("harvester", [WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], 1),
                ...
                "harvesterV2": new CreepSpawningInfo("harvesterV2", [WORK, WORK, WORK, WORK, WORK, CARRY, CARRY, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE], 3),
